...
<title>습득물 페이지</title>
    ...
    <!--[if lt IE 9]>
      ...
      <script src="https://oss.maxcdn.com/libs/respond.lnf/js1.4.2/respond.min.js"></script>
    <![endif]-->
...
<body>
   ...
   <!-- Start Shop Page  -->
    ...
    <script src="lnf/jsjquery-ui.js"></script>
    <script src="lnf/jsjquery.nicescroll.min.js"></script>
