...
<body>
					...
					<form id="frm" action="lostNoticeSelect.do" method="post">
						<div class="single-product-details">
							...
							<div class="add-to-btn">
								<div class="add-comp">
									<a class="btn hvr-hover" href="#" id="lFnHit" name="lFnHit"
										onclick="()"><i class="fas fa-heart"></i> 조회수
										${lfnotice.LFnHit }</a> <a class="btn hvr-hover"
										href="lostNotice.do">목록가기</a>
								</div>
								<div class="share-bar">
    ...
    naver.maps.Service.geocode({
		...
		var mapOptions = {
			center : new naver.maps.LatLng(y,
					x),
			zoom : 19
		};
		var map = new naver.maps.Map('maps', mapOptions);	
		var markerOptions = {
			position : new naver.maps.LatLng(y,
					x),
			map : map
